...
const sections = [
  {
    ...
    images: [
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/homepage1.webp",
        comment: "메인페이지 시연영상. 해당하는 요일만 효율적으로 GET요청",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/homepage-changevideo.webp",
        comment: "새로고침시 변경되는 메인영상",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/homepageSelectVideo.webp",
...

  {
    ...
    images: [
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/loginCheck.webp",
        comment: "로그인 실패 시 횟수제한, 성공 후 refresh, access 토큰확인",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/loginOAuth.webp",
  ...
  },
  {
    ...
    images: [
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/broadcastlist1.webp",
        comment:
          "방송리스트 시연영상. 모든 방송엔 각자 에피소드 추가하는기능이 있고, 수정or삭제 버튼 클릭 시 해당방송의 고유번호에 따라 데이터를 바인딩. 혹은 삭제.",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/contentsaddserarch.webp",
        comment: "방송(콘텐츠)추가 시연영상1. 검색기능도 구현했다.",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/postContent.webp",
        comment:
          "방송(콘텐츠)추가 시연영상2. 실제 방송을 추가하여 디테일화면에서 방송 진행자 정보도 팝업으로 확인가능하다.",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/contentsModifyDelete.webp",
        comment:
    ...
    spDescription: {
      image: [
        "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/contentsAddFrontCode.PNG",
      ],
      comment:
  ...
  },
  {
    ...
    images: [
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/adminFrontMiddleware.PNG",
        comment:
          "클라이언트(프런트엔드) 미들웨어. 단순하게 유저정보만을 확인한다",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/adminServerMiddleware.PNG",
        comment:
  ...
  },
  {
    ...
    images: [
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/adminChangeUserinfo.webp",
        comment:
          "운영자페이지 유저정보 변경 시연. 프리미엄/일반회원(role) 변경, 프리미엄 기간 등을 변경하면 좋을 것 같다.",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/adminChangeBanner.webp",
        comment: "배너관리 시연",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/memberSearch.PNG",
        comment: "멤버목록 검색 코드",
      },
    ],
    description:
    ...
    spDescription: {
      image: [
        "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/memberSearchJaum.PNG",
      ],
      comment:
  ...
  },
  {
    ...
    images: [
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/S3upload1.PNG",
        comment:
          "FormComponent안에 FileUploadComponent를 자식 컴포넌트로 추가한다",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/S3upload2.PNG",
        comment:
          "FileUploadComponent의 handleFileChange함수. uploadToS3함수를 발동하고, 부모컴포넌트에 발급받은 PresignedURL을 전달한다",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/S3upload4.PNG",
        comment:
          "composable/userS3Upload.ts의 uploadToS3함수. file과 temp를 파라미터로 받고 파일사이즈같은것도 검증. api/upload로 API요청한다.",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/S3upload5.PNG",
        comment:
          "api/upload 엔드포인트의코드. S3관련 환경변수도 까보고 디코딩 등의 작업도 수행하고 presiginedURL을 요청한다.",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/S3upload7.PNG",
        comment:
          "다시 uploadToS3함수로 돌아와서 API요청이 성공했으면 uploadedUrl 변수에 해당 URL을 담는다.",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/S3upload8.PNG",
        comment:
          "FileUploadComponent의 comfirmFile함수. 여기서도 한번 더 uploadToS3함수를 실행하는데 이번엔 두번째 파라미터값(temp)이 false다 임시파일이아닌 확정적인 파일이므로.",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/S3upload9.PNG",
        comment:
    ...
    spDescription: {
      image: [
        "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/S3uploadfinal.PNG",
      ],
      comment:
  ...
  },
  {
    ...
    images: [
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/deploy1.PNG",
        comment: "GoogleKeep에 정리한 배포과정 1",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/deploy2.PNG",
        comment: "GoogleKeep에 정리한 배포과정 2",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/deploy3.PNG",
        comment: "GoogleKeep에 정리한 배포과정 3",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/deploy4.PNG",
    ...
    spDescription: {
      image: [
        "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/deployGithubAction.PNG",
      ],
      comment:
  ...
  },
  {
    ...
    images: [
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/imgbell/1.SSRUseAsyncData.PNG",
        comment: "기존의 onMounted와 SSR에 맞춰진 useAsyncData 사용 코드 비교",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/imgbell/1.SSRPage.webp",
        comment: "이전과 같이 정상적으로 렌더링 되고있다.",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/imgbell/1.SSRSEOMeta.PNG",
        comment:
