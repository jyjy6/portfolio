...
const AIComments = [
  {
    id: 0,
    model: "ChatGPT-5",
    img: "https://juneyoung4da.s3.ap-northeast-2.amazonaws.com/portfolio/gpt5.jpg",
    jpComment:
  ...
  },
  {
    ...
    img: "https://juneyoung4da.s3.ap-northeast-2.amazonaws.com/portfolio/Gemini.jpg",
    jpComment:
        ...
        <v-expansion-panel-text>
          <TranslationComponent>
            <div>
              ...
              부족한 인간의 지능, 기억력을 AI가 메꿔준다면 <br /><br />
              그걸 활용하는 센스를 발휘하는게 AI시대에 맞춰 해야 할 일이라고
              생각합니다🚀
            </div>
          </TranslationComponent>
          <br />
