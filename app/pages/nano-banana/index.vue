...
const sections = [
  {
    ...
    images: [
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/01.ali_usyk_together.webp",
        comment:
          '서비스 시연영상. 전설적인 두 프로복서 THE GOAT "무하마드 알리", 헤비급 역대 최강의 프로복서 "올렉산드르 우식"을 한 이미지에 넣어보고 싶었다. 프롬프트는 영어로.',
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/01.ali_usyk_results.png",
        comment:
          "완성된 결과물. 두 선수가 복서라는 말도 하지 않았음에도 불구하고 이미지의 분위기를 파악하고 링의 분위기를 상당히 일관성있고 정확하게 표현하고있다.",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/01.trump_request.jpg",
        comment:
          "이번엔 1개의 이미지만으로 요청해보자. 도널드 트럼프에게 시그니쳐 모자를 씌워주자",
      },
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/01.trump_results.png",
        comment:
    ...
    spDescription: {
      image: [
        "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/02.requestToAI.jpg",
      ],
      comment:
  ...
  },
  {
    ...
    images: [
      {
        image:
          "https://pub-b524f036811a4a299e3f34d9ebc53721.r2.dev/portfolio/banonanademo.webp",
        comment:
